...
class Glass(Scatter):
    ...
    def __init__(self, **kwargs):
        ...
        # self.img = Image(source=self.bg_img.source, keep_data=True)
        # self.coreimage = CoreImage(self.bg_img.source, keep_data=True)
        # if self.background_img != '':
        #     self.bg_img = Image(source=self.background_img, size_hint=(None,None), size=self.size, keep_data=True)
        #     self.add_widget(self.bg_img)
        # if self.glass_img != '':
        #     glass_img = Image(source=self.glass_img , size_hint=(None,None), size=self.size, color=self.color)
        #     self.add_widget(glass_img)
