...
from kivy.properties import StringProperty, OptionProperty,\
                             ObjectProperty, BooleanProperty, NumericProperty, ListProperty
...
class AnimatedButton(Label):
    ...
    total_frames = NumericProperty(30)
    ...
    def __init__(self, **kwargs):
        ...
        self.img = Image(source = self.background_normal, color=(1,1,0,1))
    ...
    def on_tex_changed(self, *largs):
        ...
        # if self.img._coreimage.anim_index == self.total_frames -1:
